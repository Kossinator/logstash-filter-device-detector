Gem::Specification.new do |s|
  ...
  s.summary       = 'Custom logstash filter for device_detector.'
  s.description   = 'Detects a vast amount of different devices automaticly based on regex rules.'
  s.homepage      = 'https://github.com/Kossinator/logstash-filter-device_detector'
  s.authors       = ['Alexander Koss']
  s.email         = 'alexander.koss@loadbee.com'
  s.require_paths = ['lib']
